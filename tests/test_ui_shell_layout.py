...
class PageRhythmTests(unittest.TestCase):
    ...
    def test_shared_line_and_transport_selectors_keep_text_and_controls_aligned(self):
        ...
        self.assertIn("grid-template-columns:max-content 680px max-content", css_rule(".u-line-selector"))
    ...
    def test_full_device_detection_is_visible_in_empty_state_and_has_fixed_feedback(self):
        ...
        self.assertIn("discovering ? <Discovering", UNIFIED)
        self.assertIn("!d ? <Empty", UNIFIED)
        self.assertIn('className="u-device-sidebar-footer"', UNIFIED)
